  ...
  return (
    ...
    <div>
      ...
      <div>
          ...
          >
              <div className="h-max-14 w-max-14 rounded-4xl overflow-hidden content-center border-2 border-solid border-neutral-500 "> <img src="/images/EricKarusseit.Foto.png" alt="Eric Karusseit" /></div>
