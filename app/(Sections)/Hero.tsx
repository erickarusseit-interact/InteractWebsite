          ...
          <div className='flex flex-col items-start w-full max-w-[500px] md:max-w-none border border-[#292524] rounded-md overflow-visible'>
            ...
            <div className='relative flex flex-col items-center p-3 sm:p-4 md:p-5 lg:p-6 w-full flex-1 isolate overflow-visible'>
              ...
              <div className='relative w-full aspect-[2/1] min-h-[100px] sm:min-h-[140px] md:min-h-[160px] lg:min-h-[180px] overflow-visible'>
                ...
                <div
                  className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%+25px)] h-[calc(100%+20px)] bg-purple-500/50   rounded-[14px] z-[1]'
                  style={{
                    filter: 'blur(80px)',
                ...
                <div
                  className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-purple-300   rounded-[14px] z-[2]'
                  style={{
                    filter: 'blur(20px)',
                    boxShadow: '0px 0px 4px #FFFFFF'
                  }}
                ...
                <div
                  className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[92%] h-[85%] bg-purple-50/100 rounded-[24px] z-[3]'
                  style={{
                    filter: 'blur(10px)'
                  }}
                />
                  ...
                  <div
                      className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[58%] bg-purple-200/80  rounded-[14px] z-[3]'
                      style={{
                          filter: 'blur(15px)'
                      }}
                  />
