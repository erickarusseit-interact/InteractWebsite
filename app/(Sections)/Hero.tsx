...
export default function Hero() {
    return <section className=' h-fit mx-auto max-w-[1440px] bg-black text-neutral-100 sm:px-8 pt-32 pb-30 lg:px-20 flex flex-col md:flex-row md:pt-32 md:pb-24 lg:pt-48 lg:pb-32 xl:flex-row items-center justify-between w-full gap-24 2xl:gap-0 overflow-x-hidden'>
    <div className='flex flex-col gap-4 items-center md:items-start w-full md:w-1/2 text-center md:text-left  '>
        <div className='flex flex-col gap-2'>
        <h1 className='text-neutral-100 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl w-fit '> Andere raten, <br/>Wir wissen</h1>
            ...
            <div className='relative flex flex-col items-center p-3 sm:p-4 md:p-5 lg:p-6 w-full flex-1 overflow-visible box-border'>
              ...
              <div className='relative w-full aspect-[2/1] min-h-[100px] sm:min-h-[140px] md:min-h-[160px] lg:min-h-[180px] overflow-visible'>
                ...
                />
                  ...
                  <ElectricBorder
                      className='relative w-full h-full z-[20] inset-0'
                      color="#FFFFFF"
                      speed={1}
                      chaos={0.02}
